...
using WeatherComponent.Service;

namespace MVC_DecoratorPattern
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //---------Simple service registion
            services.AddScoped<Ilogger>(serviceProvider => new LoggerService());

            //--------- How to register decorator class
